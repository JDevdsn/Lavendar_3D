...
import { map, lerp, clamp, getMousePos } from './utils2';
const images = Object.entries(require('../src/img/*.jpg'));
...
export default class MenuItem {
    constructor(el, inMenuPosition, animatableProperties) {
        // el is the <a> with class "menu5__item"
        this.DOM = {el: el};
        // position in the Menu5
        this.inMenuPosition = inMenuPosition;
        // menu item properties that will animate as we move the mouse around the menu
        this.animatableProperties = animatableProperties;
        // the item text
        this.DOM.textInner = this.DOM.el.querySelector('.menu5__item-textinner');
